   ...
   <?php include('includes/preloader.php');?>
        ...
        <div class="page-wrapper">
           ...
           <?php include('includes/titlebar.php');?>
            ...
            <div class="container-fluid">
                                    ...
                                    <table id="tableData" class="display nowrap table table-striped  table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                           <tr>
                                            ...
                                            <th style="width: 55% !important;">Parameters</th>
                ...
                <!--<button type="button" class="btn btn-success m-1" onclick="success_noti()">SUCCESS</button>-->
                <!-- End PAge Content -->
    ...
    function saveValue(Id, WebId) {
                   ...
                   var time =    $("#time").val();
                    ...
                    var url = baseServiceUrl + 'streams/' + WebId + '/recorded';
                    var data = [{
                        "Timestamp": dateTime,
