AmCharts.themes.light= {
    ...
    ,
    AmCoordinateChart: {
        colors: ["#1976d2", "#de4c4f", "#6610f2", "#ffc107", "#cd82ad", "#2f4074", "#448e4d", "#b7b83f", "#b9783f", "#b93e3d", "#913167"]
    }
    ,
    AmStockChart: {
        colors: ["#1976d2", "#de4c4f", "#6610f2", "#ffc107", "#cd82ad", "#2f4074", "#448e4d", "#b7b83f", "#b9783f", "#b93e3d", "#913167"]
    ...
    ,
    AmSlicedChart: {
        colors: ["#1976d2", "#de4c4f", "#6610f2", "#ffc107", "#cd82ad", "#2f4074", "#448e4d", "#b7b83f", "#b9783f", "#b93e3d", "#913167"], outlineAlpha: 1, outlineThickness: 2, labelTickColor: "#000000", labelTickAlpha: 0.3
    }
    ,
    AmRectangularChart: {
